...
3. Dashboard/
   - Folder containing the interactive web dashboard
   - dashboard.html: Main dashboard file with live visualizations
   - embedded_data.js: JavaScript data file for the dashboard
   - Features dynamic filtering and real-time insights
   - No server required - runs directly in web browser

4. DataSet 3 - Data Science Jobs.xlsx
...
---------------------------------------------------------------
1. Navigate to the Dashboard folder and open dashboard.html in any modern web browser
...
The web dashboard (Dashboard/dashboard.html) includes:
